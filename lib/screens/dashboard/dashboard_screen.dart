...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    _carService = CarService(_authService);
  ...
  Widget build(BuildContext context) {
    final screens = [
      _buildDashboardBody(),
      CarsScreen(carService: _carService, serviceService: _serviceService),
      FuelScreen(fuelService: _fuelService, carService: _carService),
...
class _EmptyCars extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Column(
        children: [
          Icon(Icons.directions_car, size: 48, color: Color(0xFFD1D5DB)),
          SizedBox(height: 12),
          Text(
            'No cars yet',
            style: TextStyle(
  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text('Delete ${car.carModel}? All service records will remain.'),
        actions: [
          TextButton(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${car.carNumber} • ${car.carYear} • ${car.carCategory}',
                        style: const TextStyle(
                          fontSize: 12,
                          color: AppTheme.textSecondary,
                        ),
