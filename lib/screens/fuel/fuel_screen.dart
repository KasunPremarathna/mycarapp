...
class _FuelScreenState extends State<FuelScreen> {
  ...
  Future<void> _addFuel(List<CarModel> cars) async {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<CarModel>>(
      stream: widget.carService.getCars(),
      builder: (ctx, carSnap) {
